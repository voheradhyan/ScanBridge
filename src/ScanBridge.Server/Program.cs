...
{
    public const string ServiceName_ = "ScanBridge";
    ...
    protected override void OnStart(string[] args)
    {
        ...
        string agentPath = Environment.ProcessPath
            ?? Path.Combine(AppContext.BaseDirectory, "ScanBridge.Server.exe");
        ...
        CommonLog.Logger.Information("ScanBridge service started.");
    ...
    {
        CommonLog.Logger.Information("ScanBridge service stopping.");
        _launcher?.StopAll();
        _launcher?.Dispose();
        _launcher = null;
        CommonLog.Shutdown();
    ...
    private static void RunService(string[] args)
    {
        ...
        if (args.Contains("--console"))
        {
            ...
            Console.WriteLine("ScanBridge service running in console mode. Press Ctrl+C to stop.");
